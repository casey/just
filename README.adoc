...
Variadic parameters prefixed with `*` accept _zero or more_ arguments. They expand to a string containing those arguments separated by spaces, or an empty string if no arguments are present:
