...
The aliased command may not keep the shell completion functionality described in the next section. In Bash, you can use the same completion function as `just` for your aliased command.
