...
https://github.com/leon-barrett/just-mode.el[just-mode] provides syntax highlighting and automatic indentation of justfiles, and is available on https://melpa.org/[MELPA] as https://melpa.org/#/just-mode[just-mode]
