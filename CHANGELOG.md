...
- Change `fallback` setting default to false ([#1425](https://github.com/casey/just/issues/1425))
...
### Changed
- Omit shebang lines on Windows ([#1417](https://github.com/casey/just/issues/1417))

### Misc
- Placate clippy ([#1423](https://github.com/casey/just/issues/1423))
- Make include_shebang_line clearer ([#1418](https://github.com/casey/just/issues/1418))
...
### Added
- Add OS Configuration Attributes ([#1387](https://github.com/casey/just/issues/1387))

### Misc
- Link to sclu1034/vscode-just in readme ([#1396](https://github.com/casey/just/issues/1396))
...
### Breaking Changes to Unstable Features
- Require `set fallback := true` to enable recipe fallback ([#1368](https://github.com/casey/just/issues/1368))

### Changed
- Allow fallback with search directory ([#1348](https://github.com/casey/just/issues/1348))
...
### Fixed
- Fix shell setting precedence ([#1306](https://github.com/casey/just/issues/1306))
...
### Added
- Add `/` operator ([#1237](https://github.com/casey/just/issues/1237))
...
- Style and add links to homepage ([#1177](https://github.com/casey/just/issues/1177))
- Fix readme badge links ([#1176](https://github.com/casey/just/issues/1176))
- Generate book from readme ([#1155](https://github.com/casey/just/issues/1155))

[1.1.3](https://github.com/casey/just/releases/tag/1.1.3) - 2022-5-3
--------------------------------------------------------------------

### Fixed
- Skip duplicate recipe arguments ([#1174](https://github.com/casey/just/issues/1174))
...
### Misc
- Document indentation rules ([#1142](https://github.com/casey/just/issues/1142))
- Remove stale link from readme ([#1141](https://github.com/casey/just/issues/1141))

### Unstable
- Search for missing recipes in parent directory justfiles ([#1149](https://github.com/casey/just/issues/1149))

[1.1.1](https://github.com/casey/just/releases/tag/1.1.1) - 2022-3-22
---------------------------------------------------------------------

### Misc
- Build MacOS ARM release binaries ([#1138](https://github.com/casey/just/issues/1138))
- Upgrade Windows Actions runners to windows-latest ([#1137](https://github.com/casey/just/issues/1137))
...
### Breaking
- Change dotenv-load default to false ([#1082](https://github.com/casey/just/issues/1082))

[0.10.7](https://github.com/casey/just/releases/tag/0.10.7) - 2022-1-30
-----------------------------------------------------------------------

### Misc
- Don't run tests in release workflow ([#1080](https://github.com/casey/just/issues/1080))
- Fix windows chooser invocation error message test ([#1079](https://github.com/casey/just/issues/1079))
- Remove call to sed in justfile ([#1078](https://github.com/casey/just/issues/1078))
...
### Added
- Add `trim_end(s)` and `trim_start(s)` functions ([#999](https://github.com/casey/just/issues/999))
- Add more string manipulation functions ([#998](https://github.com/casey/just/issues/998))

### Changed
- Make `join` accept two or more arguments ([#1000](https://github.com/casey/just/issues/1000))
...
- Use `cargo build` instead of `cargo rustc` ([#993](https://github.com/casey/just/issues/993))
- Don't skip variables in variable iterator ([#991](https://github.com/casey/just/issues/991))
- Remove deprecated equals error ([#985](https://github.com/casey/just/issues/985))

[0.10.2](https://github.com/casey/just/releases/tag/0.10.2) - 2021-9-26
-----------------------------------------------------------------------

### Added
- Implement regular expression match conditionals ([#970](https://github.com/casey/just/issues/970))
...
- Suggest using `~/.global.justfile` instead of `~/.justfile` ([#937](https://github.com/casey/just/issues/937))
- Update man page ([#935](https://github.com/casey/just/issues/935))

[0.10.0](https://github.com/casey/just/releases/tag/0.10.0) - 2021-8-2
----------------------------------------------------------------------

### Changed
- Warn if `.env` file is loaded in `dotenv-load` isn't explicitly set ([#925](https://github.com/casey/just/issues/925))

### Added
- Add `--changelog` subcommand ([#932](https://github.com/casey/just/issues/932))
- Support `.justfile` as an alternative to `justfile` ([#931](https://github.com/casey/just/issues/931))

### Misc
- Use cargo-limit for all recipes ([#928](https://github.com/casey/just/issues/928))
- Fix colors ([#927](https://github.com/casey/just/issues/927))
- Use ColorDisplay trait to print objects to the terminal ([#926](https://github.com/casey/just/issues/926))
- Deduplicate recipe parsing ([#923](https://github.com/casey/just/issues/923))
- Move subcommand functions into Subcommand ([#918](https://github.com/casey/just/issues/918))
- Check GitHub Actions workflow with actionlint ([#921](https://github.com/casey/just/issues/921))
- Add loader and refactor errors ([#917](https://github.com/casey/just/issues/917))
- Rename: Module → Ast ([#915](https://github.com/casey/just/issues/915))

[0.9.9](https://github.com/casey/just/releases/tag/0.9.9) - 2021-7-22
---------------------------------------------------------------------

### Added
- Add subsequent dependencies ([#820](https://github.com/casey/just/issues/820))
- Implement `else if` chaining ([#910](https://github.com/casey/just/issues/910))
...
### Misc
- Fix changelog formatting ([#894](https://github.com/casey/just/issues/894))
- Only run install script on CI for non-releases ([#895](https://github.com/casey/just/issues/895))
...
- Remove outdated note in `Cargo.toml` ([#891](https://github.com/casey/just/issues/891))
- Link to GitHub release pages in changelog ([#886](https://github.com/casey/just/issues/886))
...
- Mention that vim-just is now available from vim-polyglot ([#865](https://github.com/casey/just/issues/865))
- Mention `--list-heading` newline behavior ([#860](https://github.com/casey/just/issues/860))
- Check for `rg` in `bin/forbid` ([#859](https://github.com/casey/just/issues/859))
- Document that variables are not exported to backticks in the same scope ([#856](https://github.com/casey/just/issues/856))
- Remove `dotenv_load` from tests ([#853](https://github.com/casey/just/issues/853))
- Remove `v` prefix from version ([#850](https://github.com/casey/just/issues/850))
- Improve install script ([#847](https://github.com/casey/just/issues/847))
- Move pages assets back to `docs` ([#846](https://github.com/casey/just/issues/846))
- Move pages assets to `www` ([#845](https://github.com/casey/just/issues/845))
...
### Fixed
- Pass evaluated arguments as positional arguments ([#810](https://github.com/casey/just/issues/810))

[0.9.1](https://github.com/casey/just/releases/tag/v0.9.1) - 2021-4-24
----------------------------------------------------------------------

### Added
- Change `--eval` to print variable value only ([#806](https://github.com/casey/just/issues/806))
- Add `positional-arguments` setting ([#804](https://github.com/casey/just/issues/804))
- Allow filtering variables to evaluate ([#795](https://github.com/casey/just/issues/795))

### Changed
- Reform and improve string literals ([#793](https://github.com/casey/just/issues/793))
- Allow evaluating justfiles with no recipes ([#794](https://github.com/casey/just/issues/794))
- Unify string lexing ([#790](https://github.com/casey/just/issues/790))

### Misc
- Test multi-line strings in interpolation ([#789](https://github.com/casey/just/issues/789))
- Add shell setting examples to README ([#787](https://github.com/casey/just/issues/787))
- Disable .env warning for now
- Warn if `.env` file loaded and `dotenv-load` unset ([#784](https://github.com/casey/just/issues/784))

[0.9.0](https://github.com/casey/just/releases/tag/v0.9.0) - 2021-3-28
----------------------------------------------------------------------

### Changed
- Turn `=` deprecation warning into a hard error ([#780](https://github.com/casey/just/issues/780))

[0.8.7](https://github.com/casey/just/releases/tag/v0.8.7) - 2021-3-28
----------------------------------------------------------------------

### Added
- Add `dotenv-load` setting ([#778](https://github.com/casey/just/issues/778))

### Misc
- Change publish recipe to use stable rust ([#777](https://github.com/casey/just/issues/777))
...
### Changed
- Suppress all output to stderr when `--quiet` ([#771](https://github.com/casey/just/issues/771))

### Misc
- Improve chooser invocation error message ([#772](https://github.com/casey/just/issues/772))
- De-emphasize cmd.exe in readme ([#768](https://github.com/casey/just/issues/768))
- Fix warnings ([#770](https://github.com/casey/just/issues/770))

[0.8.5](https://github.com/casey/just/releases/tag/v0.8.5) - 2021-3-24
----------------------------------------------------------------------

### Added
- Allow escaping double braces with `{{{{` ([#765](https://github.com/casey/just/issues/765))
...
### Added
- Add options to control list formatting ([#753](https://github.com/casey/just/issues/753))
...
- Update man page to v0.8.3 ([#720](https://github.com/casey/just/issues/720))

[0.8.3](https://github.com/casey/just/releases/tag/v0.8.3) - 2020-10-27
-----------------------------------------------------------------------

### Added
- Allow ignoring line endings inside delimiters ([#717](https://github.com/casey/just/issues/717))
...
- Automatically track expected tokens while parsing ([#711](https://github.com/casey/just/issues/711))
- Document feature flags in Cargo.toml ([#709](https://github.com/casey/just/issues/709))
...
### Added
- Add the `--choose` subcommand ([#680](https://github.com/casey/just/issues/680))

### Misc
- Combine integration tests into single binary ([#679](https://github.com/casey/just/issues/679))
- Document `--unsorted` flag in readme ([#672](https://github.com/casey/just/issues/672))

[0.7.2](https://github.com/casey/just/releases/tag/v0.7.2) - 2020-8-23
----------------------------------------------------------------------

### Added
- Add option to print recipes in source order ([#669](https://github.com/casey/just/issues/669))

### Misc
- Mention Linux, MacOS and Windows support in readme ([#666](https://github.com/casey/just/issues/666))
- Add list highlighting nice features to readme ([#664](https://github.com/casey/just/issues/664))

[0.7.1](https://github.com/casey/just/releases/tag/v0.7.1) - 2020-7-19
----------------------------------------------------------------------

### Fixed
- Search for `.env` file from working directory ([#661](https://github.com/casey/just/issues/661))

### Misc
- Move link-time optimization config into `Cargo.toml` ([#658](https://github.com/casey/just/issues/658))

[0.7.0](https://github.com/casey/just/releases/tag/v0.7.0) - 2020-7-16
----------------------------------------------------------------------

### Breaking
- Skip `.env` items which are set in environment ([#656](https://github.com/casey/just/issues/656))

### Misc
- Mark tags that start with `v` as releases ([#654](https://github.com/casey/just/issues/654))

[0.6.1](https://github.com/casey/just/releases/tag/v0.6.1) - 2020-6-28
----------------------------------------------------------------------

### Changed
- Only use `cygpath` on shebang if it contains `/` ([#652](https://github.com/casey/just/issues/652))
...
### Fixed
- Don't require justfile to print completions ([#596](https://github.com/casey/just/issues/596))

### Misc
- Only build for linux on docs.rs ([#611](https://github.com/casey/just/issues/611))
- Trim completions and ensure final newline ([#609](https://github.com/casey/just/issues/609))
- Trigger build on pushes and pull requests ([#607](https://github.com/casey/just/issues/607))
- Document behavior of `@` on shebang recipes ([#602](https://github.com/casey/just/issues/602))
- Add `.nojekyll` file to github pages site ([#599](https://github.com/casey/just/issues/599))
- Add `:` favicon ([#598](https://github.com/casey/just/issues/598))
- Delete old CI configuration and update build badge ([#595](https://github.com/casey/just/issues/595))
- Add download count badge to readme ([#594](https://github.com/casey/just/issues/594))
- Wrap comments at 80 characters ([#593](https://github.com/casey/just/issues/593))
- Use unstable rustfmt configuration options ([#592](https://github.com/casey/just/issues/592))

[0.5.8](https://github.com/casey/just/releases/tag/v0.5.8) - 2020-1-28
----------------------------------------------------------------------

### Changed
- Only use `cygpath` on windows if present ([#586](https://github.com/casey/just/issues/586))

### Misc
- Improve comments in justfile ([#588](https://github.com/casey/just/issues/588))
- Remove unused dependencies ([#587](https://github.com/casey/just/issues/587))

[0.5.7](https://github.com/casey/just/releases/tag/v0.5.7) - 2020-1-28
----------------------------------------------------------------------

### Misc
- Don't include directories in release archive ([#583](https://github.com/casey/just/issues/583))
...
### Added
- Generate shell completion scripts with `--completions` ([#572](https://github.com/casey/just/issues/572))

### Misc
- Check long lines and FIXME/TODO on CI ([#575](https://github.com/casey/just/issues/575))
- Add additional continuous integration checks ([#574](https://github.com/casey/just/issues/574))

[0.5.4](https://github.com/casey/just/releases/tag/v0.5.4) - 2019-12-25
-----------------------------------------------------------------------

### Added
- Add `justfile_directory()` and `justfile()` ([#569](https://github.com/casey/just/issues/569))
...
### Misc
- Assert that lexer advances over entire input ([#560](https://github.com/casey/just/issues/560))
- Fix typo: `chracter` -> `character` ([#561](https://github.com/casey/just/issues/561))
- Improve pre-publish check ([#562](https://github.com/casey/just/issues/562))

[0.5.2](https://github.com/casey/just/releases/tag/v0.5.2) - 2019-12-7
----------------------------------------------------------------------

### Added
- Add flags to set and clear shell arguments ([#551](https://github.com/casey/just/issues/551))
- Allow passing arguments to dependencies ([#555](https://github.com/casey/just/issues/555))

### Misc
- Un-implement Deref for Table ([#546](https://github.com/casey/just/issues/546))
- Resolve recipe dependencies ([#547](https://github.com/casey/just/issues/547))
- Resolve alias targets ([#548](https://github.com/casey/just/issues/548))
- Remove unnecessary type argument to Alias ([#549](https://github.com/casey/just/issues/549))
- Resolve functions ([#550](https://github.com/casey/just/issues/550))
- Reform scope and binding ([#556](https://github.com/casey/just/issues/556))

[0.5.1](https://github.com/casey/just/releases/tag/v0.5.1) - 2019-11-20
-----------------------------------------------------------------------

### Added
- Add `--init` subcommand ([#541](https://github.com/casey/just/issues/541))

### Changed
- Avoid fs::canonicalize ([#539](https://github.com/casey/just/issues/539))

### Misc
- Mention `set shell` as alternative to installing `sh` ([#533](https://github.com/casey/just/issues/533))
- Refactor Compilation error to contain a Token ([#535](https://github.com/casey/just/issues/535))
- Move lexer comment ([#536](https://github.com/casey/just/issues/536))
- Add missing `--init` test ([#543](https://github.com/casey/just/issues/543))
...
- Add `set shell := [...]` to grammar ([#526](https://github.com/casey/just/issues/526))
- Add `shell` setting ([#525](https://github.com/casey/just/issues/525))
- Document settings in readme ([#527](https://github.com/casey/just/issues/527))

### Changed
- Reform positional argument parsing ([#523](https://github.com/casey/just/issues/523))
- Highlight echoed recipe lines in bold by default ([#512](https://github.com/casey/just/issues/512))

### Misc

- Gargantuan refactor ([#522](https://github.com/casey/just/issues/522))
- Move subcommand execution into Subcommand ([#514](https://github.com/casey/just/issues/514))
- Move `cd` out of Config::from_matches ([#513](https://github.com/casey/just/issues/513))
- Remove now-unnecessary borrow checker appeasement ([#511](https://github.com/casey/just/issues/511))
- Reform Parser ([#509](https://github.com/casey/just/issues/509))
- Note need to publish with nightly cargo ([#506](https://github.com/casey/just/issues/506))
...
### Documented
- Document multi-line constructs (for/if/while) ([#453](https://github.com/casey/just/issues/453))
- Generate man page with help2man ([#463](https://github.com/casey/just/issues/463))
- Add context to deprecation warnings ([#473](https://github.com/casey/just/issues/473))
- Improve messages for alias error messages ([#500](https://github.com/casey/just/issues/500))
...
- Fix `summary` feature conditional compilation ([#475](https://github.com/casey/just/issues/475))
- Allow integration test cases to omit common values ([#480](https://github.com/casey/just/issues/480))
- Add `unindent()` for nicer integration test strings ([#481](https://github.com/casey/just/issues/481))
- Start pulling argument parsing out of run::run() ([#483](https://github.com/casey/just/issues/483))
- Add explicit `Subcommand` enum ([#484](https://github.com/casey/just/issues/484))
- Avoid using error code `1` in integration tests ([#486](https://github.com/casey/just/issues/486))
- Use more indented strings in integration tests ([#489](https://github.com/casey/just/issues/489))
- Refactor `run::run` and Config ([#490](https://github.com/casey/just/issues/490))
- Remove `misc.rs` ([#491](https://github.com/casey/just/issues/491))
- Remove unused `use` statements ([#497](https://github.com/casey/just/issues/497))
- Refactor lexer tests ([#498](https://github.com/casey/just/issues/498))
...
- Disable FreeBSD builds ([#474](https://github.com/casey/just/issues/474))
- Use `bash` as shell for all integration tests ([#479](https://github.com/casey/just/issues/479))
...
### Changed
- Deprecate `=` in assignments, aliases, and exports in favor of `:=` ([#413](https://github.com/casey/just/issues/413))

### Added
- Pass stdin handle to backtick process ([#409](https://github.com/casey/just/issues/409))
...
- Remove stray source files ([#408](https://github.com/casey/just/issues/408))
- Replace some calls to brev crate ([#410](https://github.com/casey/just/issues/410))
- Lexer code deduplication and refactoring ([#414](https://github.com/casey/just/issues/414))
- Refactor and rename test macros ([#415](https://github.com/casey/just/issues/415))
- Move CompilationErrorKind into separate module ([#416](https://github.com/casey/just/issues/416))
- Remove `write_token_error_context` ([#417](https://github.com/casey/just/issues/417))

[0.4.2](https://github.com/casey/just/releases/tag/v0.4.2) - 2019-04-12
-----------------------------------------------------------------------

### Changed
- Regex-based lexer replaced with much nicer character-at-a-time lexer ([#406](https://github.com/casey/just/issues/406))

[0.4.1](https://github.com/casey/just/releases/tag/v0.4.1) - 2019-04-12
-----------------------------------------------------------------------

### Changed
- Make summary function non-generic ([#404](https://github.com/casey/just/issues/404))
...
### Changed
- Upgrade to Rust 2018 ([#394](https://github.com/casey/just/issues/394))
- Format the codebase with rustfmt ([#346](https://github.com/casey/just/issues/346))
...
### Fixed
- Use PutBackN instead of PutBack in parser ([#364](https://github.com/casey/just/issues/364))
...
### Fixed
- Fixed colors on windows ([#317](https://github.com/casey/just/issues/317))

[0.3.10](https://github.com/casey/just/releases/tag/v0.3.10) - 2018-3-19
------------------------------------------------------------------------

### Added
- Make .env vars available in env_var functions ([#310](https://github.com/casey/just/issues/310))

[0.3.8](https://github.com/casey/just/releases/tag/v0.3.8) - 2018-3-5
---------------------------------------------------------------------

### Added
- Add dotenv integration ([#306](https://github.com/casey/just/issues/306))

[0.3.7](https://github.com/casey/just/releases/tag/v0.3.7) - 2017-12-11
-----------------------------------------------------------------------

### Fixed
- Fix error if ! appears in comment ([#296](https://github.com/casey/just/issues/296))

[0.3.6](https://github.com/casey/just/releases/tag/v0.3.6) - 2017-12-11
-----------------------------------------------------------------------

### Fixed
- Lex CRLF line endings properly ([#292](https://github.com/casey/just/issues/292))

[0.3.5](https://github.com/casey/just/releases/tag/v0.3.5) - 2017-12-11
-----------------------------------------------------------------------

### Added
- Align doc-comments in `--list` output ([#273](https://github.com/casey/just/issues/273))
- Add `arch()`, `os()`, and `os_family()` functions ([#277](https://github.com/casey/just/issues/277))
- Add `env_var(key)` and `env_var_or_default(key, default)` functions ([#280](https://github.com/casey/just/issues/280))
...
### Added
- Started keeping a changelog in CHANGELOG.md ([#220](https://github.com/casey/just/issues/220))
- Recipes whose names begin with an underscore will not appear in `--list` or `--summary` ([#229](https://github.com/casey/just/issues/229))
