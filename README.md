...
| `[dragonfly]`<sup>1.47.0</sup> | any | Enable item on DragonFly BSD. |
...
| `[freebsd]`<sup>1.47.0</sup> | any | Enable item on FreeBSD. |
| `[group(NAME)]`<sup>1.27.0</sup> | module, recipe | Put recipe or module in [group](#groups) `NAME`. |
| `[android]`<sup>1.50.0</sup> | any | Enable item on Android. |
| `[linux]`<sup>1.8.0</sup> | any | Enable item on Linux. |
| `[macos]`<sup>1.8.0</sup> | any | Enable item on macOS. |
| `[metadata(METADATA)]`<sup>1.42.0</sup> | recipe | Attach `METADATA` to recipe. |
| `[netbsd]`<sup>1.47.0</sup> | any | Enable item on NetBSD. |
...
| `[openbsd]`<sup>1.38.0</sup> | any | Enable item on OpenBSD. |
...
| `[unix]`<sup>1.8.0</sup> | any | Enable item on unixes. (Includes macOS). |
| `[windows]`<sup>1.8.0</sup> | any | Enable item on Windows. |
