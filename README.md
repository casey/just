...
| `[cache]`<sup>master</sup> | recipe | Don't run invocations of this recipe if an entry matching the invocation exists in the cache. See [cached recipes](#cached-recipes) for details. Currently unstable. |
